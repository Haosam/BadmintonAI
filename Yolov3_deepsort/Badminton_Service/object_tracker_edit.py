    ...
    while True:
        ...
        for track in tracker.tracks:
            ...
            if class_name+str(track.track_id) == "Player1":
                cv2.putText(img, player[0] ,(int(bbox[0]), int(bbox[1]-10)),0, 0.75, (255,255,255),2)
                # print("1: ", int(bbox[3]))
                s_height0 = ((int(bbox[3])-(int(bbox[1])))/player[1])*1.15
            ...
            if class_name+str(track.track_id) == "Player2":
                cv2.putText(img, player[2],(int(bbox[0]), int(bbox[1])),0, 0.75, (255,255,255),2)
                # print("2: ", int(bbox[3]))
                s_height1 = ((int(bbox[3])-(int(bbox[1])))/player[3])*1.15
            ...
            if class_name+str(track.track_id) == "Player3":
                cv2.putText(img, player[4],(int(bbox[0]), int(bbox[1])),0, 0.75, (255,255,255),2)
                # print("2: ", int(bbox[3]))
                s_height2 = ((int(bbox[3])-(int(bbox[1])))/player[5])*1.15
            ...
            if class_name+str(track.track_id) == "Player4":
                cv2.putText(img, player[6],(int(bbox[0]), int(bbox[1])),0, 0.75, (255,255,255),2)
                # print("2: ", int(bbox[3]))
                s_height3 = ((int(bbox[3])-(int(bbox[1])))/player[7])*1.15
